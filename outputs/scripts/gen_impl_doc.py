...
<h3>5.1 M1 已完成成果</h3>
<ul>
<li><code>outputs/scripts/collect_real_data.py</code> — 完整采集计算脚本，可重复运行</li>
<li><code>outputs/real_data_timeseries.csv</code> — 1,185 行时间序列数据</li>
<li><code>outputs/real_data_summary.json</code> — 计算结果摘要</li>
